% !TeX root=../../../../../../beamerouterthemeFeather
\useoutertheme[left]{sidebar}

\newcommand{\tikzCircleNoFilled}
{\tikz\draw[radius=1.5pt,line width = 0.1pt,color=beamer@headercolor] (0,0) circle ;}%
\newcommand{\tikzCircleFilled}
{\tikz\draw[radius=1.5pt,line width = 0.1pt,color=beamer@headercolor, fill=beamer@headercolor] (0,0) circle ;}%
...
\def\insertverticalnavigation#1{%
	\hspace*{5pt}
	\begin{minipage}[t]{0.85\SidebarWidth}
		\vspace*{15pt}
		\vbox to \paperheight{%
...
{
	% Esto es cuando se ilumina la bola
	\usebeamercolor{subsection in sidebar}\tikzCircleFilled
}
...
\setbeamertemplate{subsection in sidebar shaded}
{
	...
	\usebeamercolor{subsection in sidebar shaded}\tikzCircleNoFilled
}
