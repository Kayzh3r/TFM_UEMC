...
\begin{figure}[ht!]
	...
	\resizebox{\textwidth}{!}{
		...
		\node [circle_op] (v4) at (0.5,1.25) {x};
...
\begin{itemize}
	...
	\item $h_t$ representan las salidas. Las operaciones en círculo o elipse son operaciones elemento a elemento de un vector respecto del otro.
