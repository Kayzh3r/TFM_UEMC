...
\begin{lstlisting}[basicstyle=\tiny\ttfamily, language=html, caption={Ejemplo de la información contenida para uno de los libros},captionpos=b, label={lst: librivox_book}]
