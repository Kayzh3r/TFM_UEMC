...
%
%%%%%%%%%%% DOCUMENT DATA %%%%%%%%%%%%
\newcommand{\project}{Eliminación de ruido espectral basado en redes neuronales}
\newcommand{\projectshort}{Eliminación de ruido con LSTM}
\newcommand{\authorname}{Ignazio F.Finazzi}
\newcommand{\tutoredby}{Patricia Jiménez Fernández}
\newcommand{\company}{Universidad Europea Miguel de Cervantes}
\newcommand{\doctype}{release} %or draft
