...
\begin{tabular}{l c l}
\toprule
\multirow{3}[2]{*}{\includegraphics[width=25mm]{Logo/uemc_logo.pdf}} & \multirow{3}{*}{
	\begin{minipage}{7cm}
		\begin{center} \textbf{\project} \\ \scriptsize{\leftmark}
		\end{center} \ifthenelse{\equal{\projectshort}{}}{\project}{} 
	\end{minipage}
} & 
Fecha:\printDate \\
&       & \chaptername\ \thechapter \\
&       & Pag.:\thepage\ de \pageref{LastPage}\\ \bottomrule
\end{tabular}}}
}
